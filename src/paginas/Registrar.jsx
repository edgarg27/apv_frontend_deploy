...
const Registrar = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (password !== repetirpassword) {
            setAlerta({ msg: 'Las contraseñas no son identicas', error: true });
            return;
        }

        if (password.length < 6) {
            setAlerta({ msg: 'La contraseña es muy corta, por lo menos minimo 6 caracteres', error: true });
            return;
        }
    ...
    return (
        <>
            <div>
                <h1 className=" text-indigo-600 font-black text-6xl">Crea tu cuenta para administrar <span className=" text-black">pacientes</span></h1>
            </div>
            ...
            <div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="my-5">
                        <label htmlFor="" className="uppercase text-gray-600 block text-xl font-bold">Repite contraseña</label>
                        <input
                            type="password"
