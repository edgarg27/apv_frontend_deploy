...
const Login = () => {
    ...
    return (
        <>
            <div>
                <h1 className=" text-indigo-600 font-black text-6xl">Inicia sesion y Administra los <span className=" text-black">pacientes</span></h1>
            </div>
            ...
            <div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="my-5">
                        ...
                        <input type="password" placeholder="Contraseña" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl"
                            value={password}
