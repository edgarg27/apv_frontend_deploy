...
const OlvidePassword = () => {
    ...
    const handleSubmit = async e => {
        ...
        if (email === '' || email.length < 6) {
            setAlerta({ msg: 'El email es obligarorio', error: true })
            return;
        }
    ...
    return (
        <>
            <div>
                <h1 className=" text-indigo-600 font-black text-6xl">Recupera tu acceso y no pierdas los <span className=" text-black">pacientes</span></h1>
            </div>
